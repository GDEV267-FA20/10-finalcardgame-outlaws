...
public class ThreeDays : MonoBehaviour {
    ...
    void Awake() {
        ...
        DoctorPlace.transform.position = new Vector3(-348f, 170f, 0f) + 
                                         new Vector3(500.5f, 281.5f, 0f) +
